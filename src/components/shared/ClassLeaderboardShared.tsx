              ...
              return (
                ...
                >
                  <div className="relative mb-4">
                    <Avatar className={`h-32 w-32 border-8 ${isCurrentStudent ? 'border-yellow-300' : 'border-white'} shadow-2xl`}>
                      <AvatarImage 
                  ...
                  return (
                    <div
                      ...
                      className={`grid grid-cols-[80px_1fr_100px] gap-4 px-6 py-4 cursor-pointer transition-all hover:bg-gray-50 ${
                        isCurrentStudent ? 'bg-yellow-50 ring-2 ring-yellow-300' : ''
                      }`}
                      onClick={() => setSelectedStudent({ id: entry.student_id, name: entry.students?.full_name })}
                    >
                      ...
                      <div className="flex items-center gap-3 min-w-0">
                        <Avatar className={`h-10 w-10 flex-shrink-0 border-2 ${isCurrentStudent ? 'border-yellow-300' : 'border-gray-200'}`}>
