    ...
    >
      <DialogContent className="sm:max-w-md rounded-2xl bg-white dark:bg-[hsl(240_8%_10%)] border-slate-200 dark:border-[hsl(240_8%_18%)]">
        ...
        >
          {GRADE_OPTIONS.map((opt) => (
            <Label
              ...
              className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-[hsl(240_8%_18%)] p-3 cursor-pointer hover:bg-slate-50 dark:hover:bg-[hsl(240_8%_14%)] has-[:checked]:border-violet-500/40 has-[:checked]:bg-violet-50/50 dark:has-[:checked]:bg-[hsl(265_25%_12%)] transition-all duration-200"
            >
        ...
        <Button
          ...
          className="w-full rounded-xl bg-violet-600 hover:bg-violet-700 text-white dark:bg-[hsl(265_40%_16%)] dark:hover:bg-[hsl(265_40%_20%)] dark:text-violet-200 dark:border dark:border-[hsl(265_40%_24%)] h-11 text-sm font-medium shadow-sm"
        >
