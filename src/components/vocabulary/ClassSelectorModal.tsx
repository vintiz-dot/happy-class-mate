...
export function ClassSelectorModal({ userId, forceOpen, onForceOpenChange, onSelected }: Props) {
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-md rounded-2xl bg-[hsl(240_8%_10%)] border-[hsl(240_8%_18%)]">
        <DialogHeader>
        ...
        >
          {GRADE_OPTIONS.map((opt) => (
            <Label
              ...
              className="flex items-center gap-2 rounded-xl border border-[hsl(240_8%_18%)] p-3 cursor-pointer hover:bg-[hsl(240_8%_14%)] has-[:checked]:border-violet-500/40 has-[:checked]:bg-[hsl(265_25%_12%)] transition-all duration-200"
            >
        ...
        <Button
          ...
          className="w-full rounded-xl bg-[hsl(265_40%_16%)] hover:bg-[hsl(265_40%_20%)] text-violet-200 border border-[hsl(265_40%_24%)] h-11 text-sm font-medium"
        >
