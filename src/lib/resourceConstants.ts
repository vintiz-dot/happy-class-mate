...
export const BLOOMS_LEVELS = [
  ...
  { value: "create", label: "Create", icon: "✨", color: "bg-violet-100 text-violet-800 dark:bg-violet-900/30 dark:text-violet-300" },
] as const;

export const PYP_THEMES = [
  { value: "who_we_are", label: "Who We Are", icon: "👤", color: "bg-pink-100 text-pink-800 dark:bg-pink-900/30 dark:text-pink-300" },
  ...
  { value: "how_we_express", label: "How We Express Ourselves", shortLabel: "Expression", icon: "🎨", color: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-300" },
...
export const FILE_TYPE_MAP: Record<string, { label: string; icon: string; color: string }> = {
  ...
  "video/mp4": { label: "Video", icon: "🎬", color: "bg-purple-600" },
  "video/webm": { label: "Video", icon: "🎬", color: "bg-purple-600" },
  "audio/mpeg": { label: "Audio", icon: "🎵", color: "bg-pink-500" },
  "audio/wav": { label: "Audio", icon: "🎵", color: "bg-pink-500" },
};
...
export function getFileTypeInfo(mimeType?: string | null) {
  ...
  if (mimeType.startsWith("video/")) return { label: "Video", icon: "🎬", color: "bg-purple-600" };
  if (mimeType.startsWith("audio/")) return { label: "Audio", icon: "🎵", color: "bg-pink-500" };
